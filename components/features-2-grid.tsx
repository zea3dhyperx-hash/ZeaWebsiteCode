...
export function Features2Grid() {
  ...
  return (
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-primary">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 flex justify-center">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold flex justify-center text-primary mb-3 text-center">{feature.title}</h3>
