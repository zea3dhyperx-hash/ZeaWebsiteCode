    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-4 py-14">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-3xl mx-auto leading-relaxed text-card text-2xl">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-8">
            {[
              ...
              { name: "Finance and Insurance", icon: "💰" },
      ...
      <section className="py-24 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img
                src="/images/untitled-20design-20-2835-29.jpeg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={idx} className="bg-black border-gray-800 p-8 hover:border-yellow-500/50 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-3 text-card">{item.title}</h3>
